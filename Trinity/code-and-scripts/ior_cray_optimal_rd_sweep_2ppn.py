...
#
# % ./run_expr.py -w 3600 -d list -M '-j oe -V' -p 2 -c experiments/ior_cray_optimal_rd_sweep_2ppn.py
#
...
#  "o" : [ "%s/%s/nn/ior.out" % ( target_dirs[0], user ) ],
  "o" : [ "%s/ior_POSIXIO_2_%s.out" % ( target_dirs[0], time.mktime( datetime.datetime.now().timetuple())) ],
#
