...
#
#Haswell
#./run_expr -d sbatch -M -w 60 -M '--ntasks-per-node=2' experiments/ior_cray_optimal_wr_s2.py
#KNL
#./run_expr -d sbatch -M -w 60 -M '-p knl -C quad,cache --ntasks-per-node=2' experiments/ior_cray_optimal_wr_s2.py
#
