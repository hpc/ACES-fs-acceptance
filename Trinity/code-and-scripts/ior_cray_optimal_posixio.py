...
#
# % ./run_expr.py -w 3600 -d list -M '-j oe -V' -p 1 -c experiments/ior_cray_optimal_posixio.py
#
...
#
# Optimal will probably be 8 I/O processes per OST
#
  "n"    : [ 32 ],
}
...
#  "o" : [ "%s/%s/nn/ior.out" % ( target_dirs[0], user ) ],
  "o" : [ "%s/ior_POSIXIO_optimal_%s.out" % ( target_dirs[0], time.mktime( datetime.datetime.now().timetuple())) ],
#
