...
#  "o" : [ "%s/%s/nn/ior.out" % ( target_dirs[0], user ) ],
  "o" : [ "%s/ior_POSIX_%s.out@%s/ior_POSIX_%s.out" % ( target_dirs[0], time.mktime( datetime.datetime.now().timetuple()),target_dirs[1], time.mktime( datetime.datetime.now().timetuple())) ],
#
