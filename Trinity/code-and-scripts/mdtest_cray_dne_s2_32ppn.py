...
#  "d" : [ "%s/mdtest.%d/" % ( target, ts ) ], 
  "d" : [ "%s/nn_shared_dir/mdt_0@%s/nn_shared_dir/mdt_1@%s/nn_shared_dir/mdt_2@%s/nn_shared_dir/mdt_3@%s/nn_shared_dir/mdt_4" % ( target_dirs[1],target_dirs[1],target_dirs[1],target_dirs[1],target_dirs[1] ) ], 
#
