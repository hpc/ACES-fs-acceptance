...
#  "d" : [ "%s/mdtest.%d/" % ( target, ts ) ], 
  "d" : [ "%s/nn_shared_dir/mdt_0a@%s/nn_shared_dir/mdt_0b@%s/nn_shared_dir/mdt_0c@%s/nn_shared_dir/mdt_1@%s/nn_shared_dir/mdt_2@%s/nn_shared_dir/mdt_3@%s/nn_shared_dir/mdt_4@%s/nn_shared_dir/mdt_0a@%s/nn_shared_dir/mdt_0b@%s/nn_shared_dir/mdt_0c@%s/nn_shared_dir/mdt_1@%s/nn_shared_dir/mdt_2@%s/nn_shared_dir/mdt_3@%s/nn_shared_dir/mdt_4" % ( target_dirs[0],target_dirs[0],target_dirs[0],target_dirs[0],target_dirs[0],target_dirs[0],target_dirs[0],target_dirs[1],target_dirs[1],target_dirs[1],target_dirs[1],target_dirs[1],target_dirs[1],target_dirs[1] ) ], 
#
...
#
  ...
  #for exponent in [ 25, 50, 100, 200, 500, 1000, 2000, 5000, 10000, 50000, 100000,200000 ]:
