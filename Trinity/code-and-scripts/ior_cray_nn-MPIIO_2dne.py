...
#  "o" : [ "%s/ior_MPIIO_%s.out@%s/ior_MPIIO_%s.out" % ( target_dirs[0], time.mktime( datetime.datetime.now().timetuple()), target_dirs[1], time.mktime( datetime.datetime.now().timetuple())) ],
  "o" : [ "%s/nn_0/ior_MPIIO_%s.out@%s/nn_1/ior_MPIIO_%s.out" % ( target_dirs[0], time.mktime( datetime.datetime.now().timetuple()), target_dirs[0], time.mktime( datetime.datetime.now().timetuple())) ],
#
