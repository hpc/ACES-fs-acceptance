...
#  "o" : [ "%s/ior_MPIIO_%s.out" % ( target_dirs[0], time.mktime( datetime.datetime.now().timetuple())), "%s/ior_MPIIO_%s.out" % ( target_dirs[1], time.mktime( datetime.datetime.now().timetuple())) ],
#
